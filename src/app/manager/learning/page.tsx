...
function getReadSlugs(): Set<string> {
  ...
  try { return new Set(JSON.parse(localStorage.getItem("learning_read_manager") || "[]")); }
  catch { return new Set(); }
}

export default function ManagerLearningPage() {
  const modules = getModules("manager");
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-3 space-y-1">
                    {mod.lessons.map((lesson) => {
                      ...
                      return (
                        <Link key={lesson.slug} href={`/manager/learning/${lesson.slug}`}
