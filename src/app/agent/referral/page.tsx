  ...
  const shareTemplates = [
    {
      title: "Для соцсетей",
      text: (link: string) =>
        `Я работаю с платформой Агентум Про — современная система для юридических агентов. Присоединяйтесь: ${link}`,
    },
    {
      title: "Для мессенджеров",
      text: (link: string) =>
        `Привет! Рекомендую платформу для юридических агентов — удобная система управления лидами и выплатами. Регистрация: ${link}`,
    },
    {
      title: "Краткий",
      text: (link: string) =>
        `Агентум Про — платформа для юридических агентов. Регистрация: ${link}`,
    },
  ];
