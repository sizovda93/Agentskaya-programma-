  ...
  return (
    <div>
      <PageHeader
        ...
        description="Управление библиотекой контента для агентов"
        breadcrumbs={[
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4 mt-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mb-1">Используйте {"{REF_LINK}"} для реферальной ссылки агента</p>
              <textarea
