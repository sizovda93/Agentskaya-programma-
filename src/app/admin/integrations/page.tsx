...
const otherIntegrations = [
  ...
  { name: "Платёжная система", description: "Обработка платежей и выплат агентам", icon: CreditCard, status: "planned" as const, category: "Финансы" },
];
            ...
            <>
              ...
              {tgData.bot && (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  ...
                  <div>
                    <span className="text-muted-foreground block">Подключённых агентов</span>
