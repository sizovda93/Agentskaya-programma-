...
const roles = [
  ...
  },
  {
    id: "manager",
    name: "Менеджер",
    description: "Управление агентами, распределение лидов, мониторинг коммуникаций",
    permissions: ["Управление агентами", "Все лиды", "Все диалоги", "Рассылки", "Финансы", "Документы"],
    usersCount: 2,
